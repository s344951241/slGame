...
namespace slGame.ObjPool
{
    public class ObjectPoolManager:Singleton<ObjectPoolManager>
    {
        ...
        {
            return InternalHasObjectPool(Utility.GetFullName<T>(string.Empty));
        }
        ...
        public bool HasObjectPool(Type objectType)
        {
            ...
            return InternalHasObjectPool(Utility.GetFullName(objectType, string.Empty));
        }
        ...
        {
            return InternalHasObjectPool(Utility.GetFullName<T>(name));
        }
        ...
        public bool HasObjectPool(Type objectType, string name)
        {
            ...
            return InternalHasObjectPool(Utility.GetFullName(objectType, name));
        }
        ...
        {
            return (ObjectPool<T>)InternelGetObjectPool(Utility.GetFullName<T>(string.Empty));
        }
        /// <summary>
        /// 获取对象池。
        /// </summary>
        ...
        public ObjectPoolBase GetObjectPool(Type objectType)
        {
            ...
            return InternelGetObjectPool(Utility.GetFullName(objectType, string.Empty));
        }
        ...
        {
            return (ObjectPool<T>)InternelGetObjectPool(Utility.GetFullName<T>(name));
        }
        ...
        public ObjectPoolBase GetObjectPool(Type objectType, string name)
        {
            ...
            return InternelGetObjectPool(Utility.GetFullName(objectType, name));
        }
        ...
        {
            return InternalDestroyObjectPool(Utility.GetFullName<T>(string.Empty));
        }
        ...
        public bool DestroyObjectPool(Type objectType)
        {
            ...
            return InternalDestroyObjectPool(Utility.GetFullName(objectType, string.Empty));
        }
        ...
        {
            return InternalDestroyObjectPool(Utility.GetFullName<T>(name));
        }
        ...
        public bool DestroyObjectPool(Type objectType, string name)
        {
            ...
            return InternalDestroyObjectPool(Utility.GetFullName(objectType, name));
        }
        ...
        public bool DestroyObjectPool<T>(ObjectPool<T> objectPool) where T : ObjectBase
        {
            ...
            return InternalDestroyObjectPool(Utility.GetFullName<T>(objectPool.Name));
        }
        ...
        public bool DestroyObjectPool(ObjectPoolBase objectPool)
        {
            ...
            return InternalDestroyObjectPool(Utility.GetFullName(objectPool.ObjectType, objectPool.Name));
        }
        ...
        private ObjectPool<T> InternalCreateObjectPool<T>(string name, bool allowMultiSpawn, int capacity, float expireTime, int priority) where T : ObjectBase
        {
            if (HasObjectPool<T>(name))
            {
                throw new Exception(string.Format("Already exist object pool '{0}'.", Utility.GetFullName<T>(name)));
            }

            ObjectPool<T> objectPool = new ObjectPool<T>(name, allowMultiSpawn, capacity, expireTime, priority);
            m_ObjectPools.Add(Utility.GetFullName<T>(name), objectPool);
            return objectPool;
        }
        ...
        private ObjectPoolBase InternalCreateObjectPool(Type objectType, string name, bool allowMultiSpawn, int capacity, float expireTime, int priority)
        {
            ...
            {
                throw new Exception(string.Format("Already exist object pool '{0}'.", Utility.GetFullName(objectType, name)));
            }
            ...
            m_ObjectPools.Add(Utility.GetFullName(objectType, name), objectPool);
            return objectPool;
        }
