    ...
    public partial class ObjectTranslator
    {
        ...
        class IniterAdderUnityEngineVector2
        {
			...
			static void Init(LuaEnv luaenv, ObjectTranslator translator)
			{
				...
				translator.RegisterCaster<char>(translator.Get);
				translator.RegisterCaster<bool>(translator.Get);
			}
        }
		...
		public void Get(RealStatePtr L, int index, out char val)
        {
		    LuaTypes type = LuaAPI.lua_type(L, index);
            if (type == LuaTypes.LUA_TUSERDATA )
            {
			    val = (char)FastGetCSObj(L, index);
            }
			else if (type ==LuaTypes.LUA_TTABLE)
			{
			    val = new char();
            ...
            {
                val = (char)objectCasters.GetCaster(typeof(char))(L, index, null);
            }
        }
		
		public void Get(RealStatePtr L, int index, out bool val)
        {
		    LuaTypes type = LuaAPI.lua_type(L, index);
            if (type == LuaTypes.LUA_TUSERDATA )
            {
			    val = (bool)FastGetCSObj(L, index);
            }
			else if (type ==LuaTypes.LUA_TTABLE)
			{
			    val = new bool();
            ...
            {
                val = (bool)objectCasters.GetCaster(typeof(bool))(L, index, null);
            }
        }
